...
export function Navbar({ onToggleTheme }: NavbarProps) {
  return (
    <nav className="flex justify-between items-center border border-black/10 dark:border-white/20 rounded-full bg-black/5 dark:bg-white/10 backdrop-blur-md mx-8 laptop:mx-32 desktop:mx-50 py-4 px-8 text-zinc-900 dark:text-zinc-100 text-sm shadow-xl shadow-black/10 dark:shadow-black/50">
      <Link
        to="/"
