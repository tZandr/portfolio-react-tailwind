    ...
    <section className="py-16">
      <div className="flex flex-col gap-18 w-full">
        <div className="space-y-6">
          <div className="border-b border-zinc-300 dark:border-zinc-200/10 pb-5 mb-15">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="-mt-10 inline-flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400 hover:text-zinc-950 dark:hover:text-zinc-100 transition-colors"
        >
